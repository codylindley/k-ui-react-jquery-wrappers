...
import kuiAutoComplete from 'kendo-ui-core/js/kendo.autocomplete.js';
...
const KendoAutoComplete = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiAutoComplete.ui.AutoComplete(elementNode,this.props.options);
