# kendo-ui-react-jquery-barcode

The Kendo UI for jQuery BarCode widget wrapped as a React component.
...
```bash
npm i kendo-ui-react-jquery-barcode
```
...
* BarCode demos: [http://demos.telerik.com/kendo-ui/barcode/index](http://demos.telerik.com/kendo-ui/barcode/index)
* BarCode docs: [http://docs.telerik.com/kendo-ui/controls/barcodes/barcode/overview](http://docs.telerik.com/kendo-ui/controls/barcodes/barcode/overview)
* BarCode API: [http://docs.telerik.com/kendo-ui/api/javascript/dataviz/ui/barcode](http://docs.telerik.com/kendo-ui/api/javascript/dataviz/ui/barcode)
