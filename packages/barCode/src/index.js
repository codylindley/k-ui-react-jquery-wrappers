...
import kuiBarCode from 'kendo/js/kendo.dataviz.barcode.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoBarCode = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiBarCode.dataviz.ui.Barcode(elementNode,this.props.options);
