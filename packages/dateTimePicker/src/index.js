...
import kuiDateTimePicker from 'kendo-ui-core/js/kendo.datetimepicker.js';
...
const KendoDateTimePicker = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDateTimePicker.ui.DateTimePicker(elementNode,this.props.options);
