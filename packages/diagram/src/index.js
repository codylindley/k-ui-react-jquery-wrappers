...
import kuiDiagram from 'kendo/js/kendo.dataviz.diagram.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoDiagram = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDiagram.dataviz.ui.Diagram(elementNode,this.props.options);
