...
import kuiDialog from 'kendo-ui-core/js/kendo.dialog.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoDialog = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDialog.ui.Dialog(elementNode,this.props.options);
