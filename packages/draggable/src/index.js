...
import kuiDraggable from 'kendo-ui-core/js/kendo.draganddrop.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoDraggable = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDraggable.ui.Draggable(elementNode,this.props.options);
