...
import kuiDropTarget from 'kendo-ui-core/js/kendo.draganddrop.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoDropTarget = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDropTarget.ui.DropTarget(elementNode,this.props.options);
	...
	render: function() {
		return this.props.children ? <span>{this.props.children}</span> : <div />;
	}
});

//export the wrapped component
export default KendoDropTarget;
