...
import kuiDropTargetArea from 'kendo-ui-core/js/kendo.draganddrop.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoDropTargetArea = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiDropTargetArea.ui.DropTargetArea(elementNode,this.props.options);
...
export default KendoDropTargetArea;
