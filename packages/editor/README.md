...
The Kendo UI for jQuery Editor widget wrapped as a React component.
...
```bash
npm i -S kendo-ui-react-jquery-editor
```
...
* Editor demos: [http://demos.telerik.com/kendo-ui/editor/index](http://demos.telerik.com/kendo-ui/editor/index)
* Editor docs: [http://docs.telerik.com/kendo-ui/controls/data-management/editor/overview](http://docs.telerik.com/kendo-ui/controls/data-management/editor/overview)
* Editor API: [http://docs.telerik.com/kendo-ui/api/javascript/ui/editor](http://docs.telerik.com/kendo-ui/api/javascript/ui/editor)
