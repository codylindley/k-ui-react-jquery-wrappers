...
const KendoGantt = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiGantt.ui.Gantt(elementNode,this.props.options);
