...
import kuiLinearGauge from 'kendo/js/kendo.dataviz.gauge.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoLinearGauge = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiLinearGauge.dataviz.ui.LinearGauge(elementNode,this.props.options);
...
export default KendoLinearGauge;
