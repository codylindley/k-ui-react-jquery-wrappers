...
import kuiMap from 'kendo/js/kendo.dataviz.map.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoMap = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiMap.dataviz.ui.Map(elementNode,this.props.options);
