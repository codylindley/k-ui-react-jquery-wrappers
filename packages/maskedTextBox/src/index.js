...
import kuiMaskedTextBox from 'kendo-ui-core/js/kendo.maskedtextbox.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoMaskedTextBox = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiMaskedTextBox.ui.MaskedTextBox(elementNode,this.props.options);
...
export default KendoMaskedTextBox;
