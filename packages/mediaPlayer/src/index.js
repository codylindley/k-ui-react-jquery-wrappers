...
import kuiMediaPlayer from 'kendo/js/kendo.mediaplayer.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoMediaPlayer = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiMediaPlayer.ui.MediaPlayer(elementNode,this.props.options);
...
export default KendoMediaPlayer;
