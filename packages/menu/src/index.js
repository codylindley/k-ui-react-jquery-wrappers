...
import kuiMenu from 'kendo-ui-core/js/kendo.menu.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoMenu = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiMenu.ui.Menu(elementNode,this.props.options);
	...
	render: function() {
		return this.props.children ? this.props.children : <ul />;
	}
});

//export the wrapped component
export default KendoMenu;
