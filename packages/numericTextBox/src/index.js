...
import kuiNumericTextBox from 'kendo-ui-core/js/kendo.numerictextbox.js';
...
const KendoNumericTextBox = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiNumericTextBox.ui.NumericTextBox(elementNode,this.props.options);
