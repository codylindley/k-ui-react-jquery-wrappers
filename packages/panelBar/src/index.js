...
import kuiPanelBar from 'kendo-ui-core/js/kendo.panelbar.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoPanelBar = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiPanelBar.ui.PanelBar(elementNode,this.props.options);
