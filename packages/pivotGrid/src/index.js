...
import kuiPivotGrid from 'kendo/js/kendo.pivotgrid.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoPivotGrid = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiPivotGrid.ui.PivotGrid(elementNode,this.props.options);
