...
import kuiProgressBar from 'kendo-ui-core/js/kendo.progressbar.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoProgressBar = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiProgressBar.ui.ProgressBar(elementNode,this.props.options);
...
export default KendoProgressBar;
