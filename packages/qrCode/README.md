# kendo-ui-react-jquery-qrcode

The Kendo UI for jQuery QRcode widget wrapped as a React component.
...
```bash
npm i kendo-ui-react-jquery-qrcode
```
...
* QRcode demos: [http://demos.telerik.com/kendo-ui/qrcode/index](http://demos.telerik.com/kendo-ui/qrcode/index)
* QRcode docs: [http://docs.telerik.com/kendo-ui/controls/barcodes/qrcode/overview](http://docs.telerik.com/kendo-ui/controls/barcodes/qrcode/overview)
* QRcode API: [http://docs.telerik.com/kendo-ui/api/javascript/dataviz/ui/qrcode](http://docs.telerik.com/kendo-ui/api/javascript/dataviz/ui/qrcode)
