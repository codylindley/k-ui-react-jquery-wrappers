...
import kuiQRCode from 'kendo/js/kendo.dataviz.qrcode.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoQRCode = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiQRCode.dataviz.ui.QRCode(elementNode,this.props.options);
