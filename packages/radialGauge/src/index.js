...
import kuiRadialGauge from 'kendo/js/kendo.dataviz.gauge.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoRadialGauge = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiRadialGauge.dataviz.ui.RadialGauge(elementNode,this.props.options);
