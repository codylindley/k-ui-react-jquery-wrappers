...
import kuiSlider from 'kendo-ui-core/js/kendo.slider.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoSlider = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiSlider.ui.Slider(elementNode,this.props.options);
