...
import kuiSparklines from 'kendo/js/kendo.dataviz.sparkline.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoSparklines = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiSparklines.dataviz.ui.Sparkline(elementNode,this.props.options);
...
export default KendoSparklines;
