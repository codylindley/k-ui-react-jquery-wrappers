...
import kuiSplitter from 'kendo-ui-core/js/kendo.splitter.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoSplitter = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiSplitter.ui.Splitter(elementNode,this.props.options);
