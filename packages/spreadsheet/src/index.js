...
import kuiSpreadsheet from 'kendo/js/kendo.spreadsheet.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoSpreadsheet = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiSpreadsheet.ui.Spreadsheet(elementNode,this.props.options);
...
export default KendoSpreadsheet
