...
import kuiStockChart from 'kendo/js/kendo.dataviz.stock.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoStockChart = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiStockChart.dataviz.ui.StockChart(elementNode,this.props.options);
...
export default KendoStockChart;
