...
import kuiTabStrip from 'kendo-ui-core/js/kendo.tabstrip.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoTabStrip = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiTabStrip.ui.TabStrip(elementNode,this.props.options);
