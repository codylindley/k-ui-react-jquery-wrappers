...
import kuiToolBar from 'kendo-ui-core/js/kendo.toolbar.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoToolBar = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiToolBar.ui.ToolBar(elementNode,this.props.options);
