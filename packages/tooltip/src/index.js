...
import kuiTooltip from 'kendo-ui-core/js/kendo.tooltip.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoTooltip = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiTooltip.ui.Tooltip(elementNode,this.props.options);
