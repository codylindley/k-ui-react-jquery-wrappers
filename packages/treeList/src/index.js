...
import kuiTreeList from 'kendo/js/kendo.treelist.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoTreeList = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiTreeList.ui.TreeList(elementNode,this.props.options);
