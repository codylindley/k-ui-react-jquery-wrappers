...
import kuiTreeMap from 'kendo/js/kendo.dataviz.treemap.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoTreeMap = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiTreeMap.dataviz.ui.TreeMap(elementNode,this.props.options);
