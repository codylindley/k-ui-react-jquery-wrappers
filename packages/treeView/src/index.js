...
import kuiTreeView from 'kendo/js/kendo.treeview.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoTreeView = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiTreeView.ui.TreeView(elementNode,this.props.options);
