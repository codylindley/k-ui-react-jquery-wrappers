# kendo-ui-react-jquery-upload

The Kendo UI for jQuery Upload widget wrapped as a React component.
...
```bash
npm i -S kendo-ui-react-jquery-upload
```
...
* Upload demos: [http://demos.telerik.com/kendo-ui/upload/index](http://demos.telerik.com/kendo-ui/upload/index)
* Upload docs: [http://docs.telerik.com/kendo-ui/controls/data-management/upload/overview](http://docs.telerik.com/kendo-ui/controls/data-management/upload/overview)
* Upload API: [http://docs.telerik.com/kendo-ui/api/javascript/ui/upload](http://docs.telerik.com/kendo-ui/api/javascript/ui/upload)
