...
import kuiUpload from 'kendo/js/kendo.upload.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoUpload = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiUpload.ui.Upload(elementNode,this.props.options);
	...
	render: function() {
		return this.props.children ? this.props.children : <input type="files"/>;
	}
});
