...
import kuiValidator from 'kendo-ui-core/js/kendo.validator.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoValidator = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiValidator.ui.Validator(elementNode,this.props.options);
