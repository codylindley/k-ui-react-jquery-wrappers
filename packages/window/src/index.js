...
import kuiWindow from 'kendo-ui-core/js/kendo.window.js';
import React from 'react';
import ReactDOM from 'react-dom';
import deepDiff from 'deep-diff';

// create a React component, that is a wrapper for a Kendo UI widget
const KendoWindow = React.createClass({
	...
	componentDidMount: function() {
		...
		this.widgetInstance = new kuiWindow.ui.Window(elementNode,this.props.options);
